ESnet = typeof ESnet === "object" ? ESnet : {}; ESnet["ReactMaps"] =
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    TrafficMap: __webpack_require__(2),
	    Legend: __webpack_require__(1)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d3 = __webpack_require__(10);
	...
	var _SimpleEdge = __webpack_require__(7);

	var _SimpleEdge2 = _interopRequireDefault(_SimpleEdge);

	var _BidirectionalEdge = __webpack_require__(8);
	...
	exports["default"] = _React2["default"].createClass({
	    ...
	    render: function render() {
	        ...
	        var edgeMap = {};
	        _import2["default"].each(this.props.topology.edges, function (edge) {
	        ...
	        _import2["default"].each(this.props.selection.edges, function (edgeName) {
	        ...
	        var nodeCoordinates = {};
	        var nodes = _import2["default"].map(this.props.topology.nodes, function (node) {
	            var x = xScale(node.x);
	            var y = yScale(node.y);
	            nodeCoordinates[node.name] = { x: x, y: y };

	            var label = _import2["default"].isUndefined(node.label) ? node.name : node.label;
	            var nodeSelected = _import2["default"].contains(_this.props.selection.nodes, node.name);
	            var edgeSelected = _import2["default"].contains(secondarySelectedNodes, node.name);
	        ...
	        var nodePaths = {};
	        _import2["default"].each(this.props.paths, function (path) {
	            ...
	            for (var i = 0; i < pathSteps.length - 1; i++) {
	                ...
	                if (!_import2["default"].has(nodePaths, a)) {
	                    nodePaths[a] = { targetMap: {} };
	                }

	                if (!_import2["default"].has(nodePaths[a].targetMap, z)) {
	        ...
	        _import2["default"].each(this.props.paths, function (path) {
	            ...
	            if (pathSteps.length > 1) {
	                for (var i = 0; i < pathSteps.length - 1; i++) {
	                    var _source = pathSteps[i];
	                    var destination = pathSteps[i + 1];
	                    var sourceToDestinationName = "" + _source + "--" + destination;
	                    var destinationToSourceName = "" + destination + "--" + _source;
	        ...
	        var edges = _import2["default"].map(this.props.topology.edges, function (edge) {
	            var selected = _import2["default"].contains(_this.props.selection.edges, edge.name);
	            ...
	            if (!_import2["default"].isUndefined(edge.shape) && !_import2["default"].isNull(edge.shape)) {
	                edgeShape = edge.shape;
	            }

	            var curveDirection = "left";
	            if (!_import2["default"].isUndefined(edge.curveDirection) && !_import2["default"].isNull(edge.curveDirection)) {
	            ...
	            if (edgeDrawingMethod === "simple") {
	                return _React2["default"].createElement(_SimpleEdge2["default"], { x1: nodeCoordinates[edge.source].x,
	                ...
	                return _React2["default"].createElement(_BidirectionalEdge2["default"], { x1: nodeCoordinates[edge.source].x,
	                    x2: nodeCoordinates[edge.target].x,
	                    y1: nodeCoordinates[edge.source].y,
	                    y2: nodeCoordinates[edge.target].y,
	                    source: edge.source,
	                ...
	                if (_import2["default"].has(edgePathMap, edge.name)) {
	                    return _React2["default"].createElement(_BidirectionalEdge2["default"], { x1: nodeCoordinates[edge.source].x,
	                        x2: nodeCoordinates[edge.target].x,
	                        y1: nodeCoordinates[edge.source].y,
	                        y2: nodeCoordinates[edge.target].y,
	        ...
	        var paths = _import2["default"].map(this.props.paths, function (path) {
	            var pathName = path.name;
	            var pathSteps = path.steps;
	            var pathSegments = [];
	            ...
	            if (pathSteps.length > 1) {
	                for (var i = 0; i < pathSteps.length - 1; i++) {
	                    ...
	                    var z = undefined;
	                    var dir = undefined;
	                    var _source2 = pathSteps[i];
	                    var destination = pathSteps[i + 1];

	                    // Get the position of path (if multiple paths run parallel)
	                    if (nodeCoordinates[_source2].x < nodeCoordinates[destination].x || nodeCoordinates[_source2].y < nodeCoordinates[destination].y) {
	                        a = _source2;z = destination;
	                        dir = 1;
	                    } else {
	                        a = destination;z = _source2;
	                        dir = -1;
	                    }

	                    var pathsToDest = nodePaths[a].targetMap[z];
	                    var pathIndex = _import2["default"].indexOf(pathsToDest, pathName);
	                    var pos = (pathIndex - (pathsToDest.length - 1) / 2) * dir;

	                    // Get the edge from edgeMap
	                    var edgeName = "" + _source2 + "--" + destination;
	                    var edge = edgeMap[edgeName];

	                    // Get the shape of the edge (linear or curved) and if curved,
	                    // get the curve direction
	                    var edgeShape = "linear";
	                    if (edge && !_import2["default"].isUndefined(edge.shape) && !_import2["default"].isNull(edge.shape)) {
	                        edgeShape = edge.shape;
	                    }

	                    // either 'left' or 'right'
	                    var curveDirection = "left";
	                    if (edge && !_import2["default"].isUndefined(edge.curveDirection) && !_import2["default"].isNull(edge.curveDirection)) {
	                        curveDirection = edge.curveDirection;
	                    }
	                    ...
	                    if (_this.props.edgeDrawingMethod === "simple") {
	                        pathSegments.push(_React2["default"].createElement(_SimpleEdge2["default"], { x1: nodeCoordinates[_source2].x,
	                            y1: nodeCoordinates[_source2].y,
	        ...
	        var labels = _import2["default"].map(this.props.topology.labels, function (label) {
	        ...
	        var legend = null;
	        if (!_import2["default"].isNull(this.props.legendItems)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaseMap = __webpack_require__(1);
	...
	exports["default"] = _React2["default"].createClass({
	    ...
	    _edgeShape: function _edgeShape(name) {
	        if (_import2["default"].has(this.props.edgeShapeMap, name)) {
	    ...
	    _normalizedTopology: function _normalizedTopology() {
	        ...
	        if (_import2["default"].isNull(this.props.topology)) {
	            return null;
	        }

	        // Extents of the raw topology for scaling into width and height of the map
	        var minX = _import2["default"].min(this.props.topology.nodes, function (node) {
	            return node.x;
	        }).x;
	        var minY = _import2["default"].min(this.props.topology.nodes, function (node) {
	            return node.y;
	        }).y;
	        var maxX = _import2["default"].max(this.props.topology.nodes, function (node) {
	            return node.x;
	        }).x;
	        var maxY = _import2["default"].max(this.props.topology.nodes, function (node) {
	            return node.y;
	        }).y;
	        maxX -= minX;
	        maxY -= minY;
	        ...
	        // Create a node list
	        topology.nodes = _import2["default"].map(this.props.topology.nodes, function (node) {
	        ...
	        topology.edges = _import2["default"].map(this.props.topology.edges, function (edge) {
	        ...
	        if (this.props.traffic) {
	            _import2["default"].each(topology.edges, function (edge) {
	    ...
	    render: function render() {
	        ...
	        return _React2["default"].createElement(_BaseMap2["default"], { topology: topo,
	            width: this.props.width,
	            height: this.props.height,
	...
	exports["default"] = _React2["default"].createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.props.shape === "cloud") {
	            ...
	            var _x = this.props.x - this.props.radius;
	            var _y = this.props.y - this.props.radius;
	            var width = 2 * this.props.radius;
	            nodeElement = _React2["default"].createElement("rect", { x: _x,
	                y: _y,
	                width: width,
	                height: width,
	                style: this.props.style,
	...
	exports["default"] = _React2["default"].createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.props.nodeTypes.length > 0) {
	            _import2["default"].each(this.props.nodeTypes, function (node) {
	        ...
	        if (this.props.edgeTypes.length > 0) {
	            _import2["default"].each(this.props.edgeTypes, function (edge) {
	                var x = curX;
	        ...
	        if (this.props.colorSwatches.length > 0) {
	            (function () {
	                ...
	                _import2["default"].each(_this.props.colorSwatches, function (color) {
	                    ...
	                    elements.push(_React2["default"].createElement(
	                        "g",
	                        null,
	                        _React2["default"].createElement("rect", { x: x,
	                            y: y,
	                            width: width,
	                            height: height,
	                            stroke: color.stroke,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports["default"] = _React2["default"].createClass({
	    ...
	    render: function render() {
	        ...
	        if (!_import2["default"].isUndefined(this.props.classed)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LinearEdge = __webpack_require__(11);

	var _LinearEdge2 = _interopRequireDefault(_LinearEdge);

	var _ArcEdge = __webpack_require__(12);
	    ...
	    render: function render() {
	        ...
	        if (this.props.shape === "curved") {
	            return _React2["default"].createElement(
	                "g",
	                null,
	                _React2["default"].createElement(_ArcEdge2["default"], { name: this.props.name,
	                    x1: this.props.x1,
	                    y1: this.props.y1,
	                    x2: this.props.x2,
	                    y2: this.props.y2,
	            ...
	            return _React2["default"].createElement(
	                "g",
	                null,
	                _React2["default"].createElement(_LinearEdge2["default"], { name: this.props.name,
	                    x1: this.props.x1,
	                    y1: this.props.y1,
	                    x2: this.props.x2,
	                    y2: this.props.y2,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports["default"] = _React2["default"].createClass({
	    ...
	    render: function render() {
	        ...
	        var source = new _Vector2["default"](this.props.x1, this.props.y1);
	        var target = new _Vector2["default"](this.props.x2, this.props.y2);

	        var diff = target.clone().subtract(source);
	        var norm = diff.clone().norm();
	        var perp = new _Vector2["default"](-norm.y, norm.x);

	        var offset = new _Vector2["default"](this.props.offset, this.props.offset);
	        ...
	        var bendScalar = new _Vector2["default"](bendOffset, bendOffset);
	        ...
	        var sourceBendPerp = new _Vector2["default"](-sourceToTargetNormalize.y, sourceToTargetNormalize.x);
	        var sourceBendPerpScalar = new _Vector2["default"](position, position);
	        var sourceBendControl = sourceBendPerp.clone().multiply(sourceBendPerpScalar).add(sourceBend);

	        var targetBendPerp = new _Vector2["default"](-targetToSourceNormalize.y, targetToSourceNormalize.x);
	        var targetBendPerpScalar = new _Vector2["default"](-position, -position);
	        var targetBendControl = targetBendPerp.clone().multiply(targetBendPerpScalar).add(targetBend);

	        // Arrow at the target end
	        var arrowLengthScalar = new _Vector2["default"](-arrowLength, -arrowLength);
	        var arrowLeftScalar = new _Vector2["default"](arrowWidth / 2, arrowWidth / 2);
	        var arrowRightScalar = new _Vector2["default"](-arrowWidth / 2, -arrowWidth / 2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Victor = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/pmurphy/Code/esnet-react-maps/node_modules/css-loader/index.js!/Users/pmurphy/Code/esnet-react-maps/lib/styles/map.css", function() {
			var newContent = require("!!/Users/pmurphy/Code/esnet-react-maps/node_modules/css-loader/index.js!/Users/pmurphy/Code/esnet-react-maps/lib/styles/map.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".map-node.selected {\n\tfill: #FF4E00;\n}\n.map-edge-highlight.selected {\n\tstroke: #FF4E00;\n}\n\n//.map-node-shape-cloud {\n//    stroke: #000 !important; /* stupid cloud class in global main.css */\n//    fill: #fff;\n//    opacity: 1.0 !important; /* stupid cloud class in global main.css */\n//}\n//.map-node-label-cloud {\n//\tfill: #6D6E71;\n//\tstroke: none;\n//}\n\npath.map-edge.map-linear-edge {\n    cursor: pointer;\n}\n\npath.map-path-line {\n    stroke: steelblue;\n    fill: none;\n}\n\n.chartcontainer.chartrow {\n    background: #F5F5F5;\n    padding-top: 5px;\n    padding-left: 5px;\n    border-style: solid;\n    border-radius: 2px;\n    border-color: #E4E4E4;\n    border-width: 1px;\n}\n\n\n.construction {\n    stroke: brown;\n    stroke-width: 1px;\n    fill: brown;\n}", ""]);
