...
export interface ListManagerProps {
    ...
    value: Immutable.List<FieldValue>;
    edit: boolean;
    types: any;
    canAddItems: boolean;
 ...
 */
export declare function formList(ItemComponent: ComponentType<ListItemProps>, hideEditRemove: boolean, actionButtonIndex: number): {
    new (props: ListManagerProps): {
        errors: number[];
        missing: number[];
        handleSelectItem(i: number | null): void;
        handleRevertItem(i: number): void;
        handleChangeItem(i: number, value: FieldValue): void;
