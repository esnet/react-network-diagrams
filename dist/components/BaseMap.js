...
exports.default = _react2.default.createClass({
    ...
    handleNodeMouseDown: function handleNodeMouseDown(id, e) {
        ...
        var x = _getOffsetMousePositi.x;
        var y = _getOffsetMousePositi.y;
    ...
    handleMouseMove: function handleMouseMove(e) {
        ...
        if (this.state.dragging) {
            ...
            var x = _getOffsetMousePositi2.x;
            var y = _getOffsetMousePositi2.y;
    ...
    handleClick: function handleClick(e) {
        ...
        if (this.props.onPositionSelected) {
            ...
            var x = _getOffsetMousePositi3.x;
            var y = _getOffsetMousePositi3.y;
    ...
    render: function render() {
        ...
        var nodes = _underscore2.default.map(this.props.topology.nodes, function (node) {
            ...
            var props = _objectWithoutProperties(node, ["name", "id", "label"]);
