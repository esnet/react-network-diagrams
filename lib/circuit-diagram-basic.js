...
exports["default"] = _react2["default"].createClass({
    ...
    _renderParentNavigation: function _renderParentNavigation(parentId) {
        if (parentId) {
            return _react2["default"].createElement(
                "g",
                null,
                _react2["default"].createElement(_circuitDiagramNavigate2["default"], { direction: Directions.NORTH, ypos: 0, id: this.props.parentId })
            );
        } else {
            return null;
        }
    ...
    _renderCircuitElements: function _renderCircuitElements() {
        var result = [];
        var navId = this.props.toCircuit || null;
        ...
        result.push(_react2["default"].createElement(_circuitDiagramEndpoint2["default"], { x: x1,
            y: y1,
            key: "a",
        ...
        result.push(_react2["default"].createElement(_circuitDiagramEndpoint2["default"], { x: x2,
            y: y2,
            key: "z",
            style: this.props.endpointStyle,
            labelPosition: this.props.endpointLabelPosition,
        ...
        if (navId) {
            ...
            result.push(_react2["default"].createElement(_circuitDiagramConnection2["default"], { x1: x1,
                x2: x2,
                y1: y1,
                y2: y2,
                ...
                lineShape: this.props.linehape,
                label1: this.props.circuitLabel1,
                label2: this.props.circuitLabel2,
