...
exports["default"] = _react2["default"].createClass({
    ...
    renderEndpoints: function renderEndpoints() {
        if (this.props.arrow) {
            ...
            return _react2["default"].createElement(
                "g",
                null,
                _react2["default"].createElement(_circuitDiagramEndpoint2["default"], { x: this.props.x1,
                    y: this.props.y1,
                    key: "line-begin",
                ...
                _react2["default"].createElement(_circuitDiagramEndpoint2["default"], { x: this.props.x2,
                    y: this.props.y2,
                    key: "line-end",
                    style: this.props.style,
                    radius: this.props.radius,
    ...
    render: function render() {
        ...
        var xOffset = this.props.labelOffsetX ? this.props.labelOffsetX : this.props.radius * 1.33;
        var yOffset = this.props.labelOffsetY ? this.props.labelOffsetY : this.props.radius * 1.33;
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                "g",
                null,
                _react2["default"].createElement(_edgeSimple2["default"], /* Positional Props used by all shapes */
                { x1: this.props.x1,
                    x2: this.props.x2,
                    y1: this.props.y1,
                    y2: this.props.y2,
