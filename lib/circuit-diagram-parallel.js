...
exports["default"] = _react2["default"].createClass({
    ...
    _renderParentNavigation: function _renderParentNavigation(parentId) {
        if (parentId) {
            return _react2["default"].createElement(
                "g",
                null,
                _react2["default"].createElement(_circuitDiagramNavigateJsx2["default"], { direction: Directions.NORTH,
                    ypos: 0,
    ...
    _renderCircuitElements: function _renderCircuitElements() {
        ...
        elements.push(_react2["default"].createElement(_circuitDiagramEndpointJsx2["default"], { x: x1,
            y: y1,
            key: "a",
        ...
        elements.push(_react2["default"].createElement(_circuitDiagramEndpointJsx2["default"], { x: x2,
            y: y2,
            key: "z",
            style: this.props.endpointStyle,
            labelPosition: this.props.endpointLabelPosition,
        ...
        _underscore2["default"].each(memberList, function (member, memberIndex) {
            ...
            elements.push(_react2["default"].createElement(_circuitDiagramConnectionJsx2["default"], { x1: rx1,
                x2: rx2,
                y1: ry1,
                y2: ry2,
