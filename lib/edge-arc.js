...
exports["default"] = _react2["default"].createClass({
    ...
    render: function render() {
        ...
        */
        var testX = (sourceBendControl.x + targetBendControl.x) / 2;
        var testY = (sourceBendControl.y + targetBendControl.y) / 2;
        ...
        if (this.props.arrow) {
            return _react2["default"].createElement(
                ...
                labelElement,
                _react2["default"].createElement("circle", { cx: control.x,
                    cy: control.y,
                    r: 2 })
            );
        } else {
            return _react2["default"].createElement(
                ...
                _react2["default"].createElement("circle", { cx: control.x,
                    cy: control.y,
                    r: 2 }),
                _react2["default"].createElement("circle", { cx: testX,
                    cy: testY,
                    r: 2,
