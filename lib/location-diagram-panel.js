...
var _edgeLabelJsx = require("./edge-label.jsx");

var _edgeLabelJsx2 = _interopRequireDefault(_edgeLabelJsx);
...
exports["default"] = _react2["default"].createClass({
    ...
    _onSelectionChange: function _onSelectionChange(e, l) {
        if (!this.props.noNavigate) {
            this.props.onSelectionChange(e, l);
        }
    },

    _renderPanelLabel: function _renderPanelLabel(yStart, label, key) {
        ...
        return _react2["default"].createElement(
            ...
            {
                key: "panel-name-" + key },
            _react2["default"].createElement(_edgeLabelJsx2["default"], {
                x: x,
                y: y,
                label: label,
    ...
    _renderFrontBackLabel: function _renderFrontBackLabel(yStart, key) {
        var x = this.props.width / 2;
    ...
    _renderPanels: function _renderPanels(panelMap) {
        ...
        _underscore2["default"].each(this.props.panels, function (panel, panelIndex) {
            ...
            elements.push(_this._renderFrontBackLabel(panelY, panelIndex));
            elements.push(_this._renderPanelLabel(panelY, panel.panelName, panelIndex));
    ...
    _renderModule: function _renderModule(module, moduleY) {
        ...
        _underscore2["default"].each(module, function (circuitGroup, groupIndex) {
            // draw the endpoints
            elements.push(_this2._renderEndpoints(circuitGroup, y, groupIndex));
            // draw the lines
            elements.push(_this2._renderConnections(circuitGroup, y, groupIndex));
            y += _this2.props.couplerStyle.size + _this2.props.couplerSpacing;
        });
        return elements;
    },

    _renderEndpoints: function _renderEndpoints(circuitGroup, y, key) {
        ...
        if (circuitGroup.frontCircuit) {
            ...
            elements.push(_react2["default"].createElement(
                ...
                _react2["default"].createElement(_circuitDiagramEndpointJsx2["default"], {
                    x: x1,
                    y: y,
    ...
    _renderConnections: function _renderConnections(circuitGroup, y, key) {
        ...
        if (circuitGroup.coupler) {
            ...
            elements.push(_react2["default"].createElement(
                ...
                _react2["default"].createElement(_circuitDiagramConnectionJsx2["default"], {
                    x1: x1,
                    x2: x2,
                    y1: y,
                    y2: y,
