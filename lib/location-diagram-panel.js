...
var PatchPanelDiagram = React.createClass({
    ...
    renderPatchPanel: function renderPatchPanel(yStart, panel, label) {
        ...
        return React.createElement(
            "g",
            null,
            React.createElement("rect", { width: rectLength, x: b, y: y, height: height, rx: 2, ry: 2, style: { fill: "#E8E8E8" } }),
            this.renderCouplerLine(y, panel, b, e),
            React.createElement("rect", { className: coupler, width: rectLength, x: b, y: y, height: height, rx: 2, ry: 2 }),
    ...
    renderCouplerLine: function renderCouplerLine(yStart, panel, b, e) {
        ...
        _.each(panel, function (c) {
            ...
            elements.push(React.createElement(
                "g",
                null,
                React.createElement("polyline", { className: coupler, points: lpoints })
            ));
    ...
    renderCoupler: function renderCoupler(yStart, panel, b, e) {
        ...
        _.each(panel, function (c) {
            ...
            elements.push(React.createElement(
                ...
                React.createElement("rect", { className: coupler, width: rectLength,
    ...
    renderCircuit: function renderCircuit(coupler, b, e, y, ex, ex2) {
        return React.createElement(AttachedCircuits.Circuit, { circuit: coupler,
            begin: b,
            end: e,
            yOffset: y,
            endpointX: ex,
    ...
    renderEndpoint: function renderEndpoint(coupler, b, y, label) {
        return React.createElement(AttachedCircuits.Endpoint, { circuit: coupler,
            begin: b,
            yOffset: y,
            label: label });
    },
    ...
    render: function render() {
        ...
        */
        ...
        var panels = _.groupBy(this.props.couplers, function (c) {
            return c.panel;
        });
