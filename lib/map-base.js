...
exports["default"] = _react2["default"].createClass({
    ...
    scale: function scale() {
        console.log("Scale", this.props.bounds);
        return {
    ...
    render: function render() {
        ...
        var nodes = _underscore2["default"].map(this.props.topology.nodes, function (node) {
            ...
            var id = _underscore2["default"].isUndefined(node.id) ? node.name : node.id;
            var nodeSelected = _underscore2["default"].contains(_this.props.selection.nodes, id);
            var edgeSelected = _underscore2["default"].contains(secondarySelectedNodes, id);
            ...
            return _react2["default"].createElement(_node2["default"], {
                ...
                onMouseMove: function (type, i, posx, posy) {
                    return _this.props.onNodeMouseMove(i, posx, posy);
                },
