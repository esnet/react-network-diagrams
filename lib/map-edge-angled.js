...
exports["default"] = _react2["default"].createClass({
    ...
    render: function render() {
        ...
        var sourceRotated = this._rotateOffset(source.x + offset, source.x, source.y, sourceAngle);
        var targetRotated = this._rotateOffset(target.x - offset, target.x, target.y, targetAngle);
        ...
        var arrowHeadLocation = this._rotateOffset(target.x - diff, target.x, target.y, targetAngle);

        var arrowLeftSide = this._rotateOffset(arrowBase.x - arrowWidth / 2, arrowBase.x, arrowBase.y, 90 + targetAngle);
        var arrowRightSide = this._rotateOffset(arrowBase.x + arrowWidth / 2, arrowBase.x, arrowBase.y, 90 + targetAngle);
        ...
        /*
        if (this.props.curveDirection === "left") {
            path += " L " + sourceOffset.x + "," + targetOffset.y;
        } else if (this.props.curveDirection === "right") {
            path += " L " + targetOffset.x + "," + sourceOffset.y;
        }
        */
