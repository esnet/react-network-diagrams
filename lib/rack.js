...
exports.default = _react2.default.createClass({
    ...
    renderChildren: function renderChildren(childElements, rackPxHeight, rackPxWidth, rackPxOffset, inchToRmu, yOffsetTop, pxToInch) {
        var _this = this;
    ...
    render: function render() {
        ...
        */
        ...
        if (_react2.default.Children.count(this.props.children) >= 1) {
            childElements = this.renderChildren(this.props.children, rackPxHeight, rackPxWidth, rackPxOffset, inchToRmu, yOffsetTop, pxToInch);
        }
        return (
