...
exports["default"] = _react2["default"].createClass({
    ...
    _normalizedTopology: function _normalizedTopology() {
        ...
        topology.nodes = _underscore2["default"].map(this.props.topology.nodes, function (node) {
            ...
            var styleMap = _underscore2["default"].has(_this.props.stylesMap, node.type) ? _this.props.stylesMap[node.type] : genericStyle;
        ...
        if (this.props.showPaths) {
            topology.paths = _underscore2["default"].map(_underscore2["default"].filter(this.props.topology.paths, function (path) {
                ...
                var color = _underscore2["default"].has(_this.props.pathColorMap, path.name) ? _this.props.pathColorMap[path.name] : "lightsteelblue";
                var width = _underscore2["default"].has(_this.props.pathWidthMap, path.name) ? _this.props.pathWidthMap[path.name] : 4;
                return {
                    name: path.name,
                    steps: path.steps,
                    color: color,
    ...
    render: function render() {
        ...
        var drawingStyle = this.props.showPaths ? "simple" : "bidirectionalArrow";
