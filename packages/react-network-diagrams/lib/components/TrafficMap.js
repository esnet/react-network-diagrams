...
var TrafficMap = exports.TrafficMap = function (_React$Component) {
    ...
    function TrafficMap() {
        ...
        return _possibleConstructorReturn(this, (TrafficMap.__proto__ || Object.getPrototypeOf(TrafficMap)).apply(this, arguments));
    }
    ...
    _createClass(TrafficMap, [{
        ...
        value: function filteredPaths() {
            ...
            return _underscore2.default.filter(this.props.topology.paths, function (path) {
                if (_underscore2.default.isArray(_this2.props.showPaths)) {
                    return _underscore2.default.contains(_this2.props.showPaths, path.name);
                }
                return true;
            });
        }
        ...
        value: function buildTopology() {
            ...
            topology.nodes = _underscore2.default.map(this.props.topology.nodes, function (node) {
                ...
                var styleMap = _underscore2.default.has(_this3.props.stylesMap, node.type) ? _this3.props.stylesMap[node.type] : genericStyle;
