 ...
 */
export class Node<N extends PropertyType, E extends PropertyType = Record<string, string>> {
    private _id: string;
    ...
    public property(key: keyof N): number | string | null {
        return this._properties[key];
    }

    public addAdjacency(id: string, target: Node<N, E>, properties: E): Edge<N, E> {
