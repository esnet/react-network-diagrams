...
export default React.createClass({
    ...
    drawRack(rackPxHeight, rackPxWidth, rackPxOffset, inchToRmu) {
    ...
    renderChildren(childElements, rackPxHeight, rackPxWidth, rackPxOffset, inchToRmu) {
        const newChildren = React.Children.map(this.props.children, child => {
            ...
            const rackPxStart = rackPxHeight + this.props.yOffset + rackPxOffset;
    ...
    render() {
        ...
        const totalHeight = rackPxHeight + (this.props.yOffset * 2);
